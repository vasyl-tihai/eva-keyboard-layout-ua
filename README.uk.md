# 🇺🇦 Українські ергономічні розкладки «Евеліна» та «Ліна»
...
- [«Евеліна» — ручна оптимізація](#-гілка-евеліна--ручна-оптимізація-рекомендовано)
- [Встановлення (Vial)](#-встановлення-evavil-у-vial)
- [Історія еволюції «Евеліни»](#-історія-еволюції-евеліни)
...
Щоб вирішити це, ми пішли двома шляхами: **«Евеліна»** (ручна, логічна оптимізація)
...
| Евеліна 3.8 | 2.92 | 57.1 | 58.3 | 19.9 |
| **Евеліна 3.9** | **1.96** | 55.4 | **58.3** | 19.9 |
| Ліна | 0.97 | 74.9 | 53.8 | 24.5 |
| Canary Phonetic UA | 5.15 | 56.7 | 47.1 | 14.8 |

**Евеліна 3.9 має у 9 разів менше SFB, ніж ЙЦУКЕН**, і тримає 58 % набору на домашньому ряду.
...
## 👑 Гілка «Евеліна» — ручна оптимізація (рекомендовано)

«Евеліна» створювалася людиною для людини: частотний аналіз української, чергування рук
(приголосні здебільшого зліва, основні голосні О-А-Е-У-І — під правою рукою)
та зручні перекати (rolls).

### 🏆 Найкращий вибір: Евеліна 3.9

Найновіша версія — результат кількісного аудиту Евеліни 3.8 (методика й цифри — у
...
<p align="center">
  <img src="images/eva-3.9.svg" alt="Розкладка Евеліна 3.9 — помаранчевим виділено клавіші, що змінилися відносно 3.8" width="700">
</p>
...
[історії еволюції](#-історія-еволюції-евеліни) нижче.
...
Шари у файлі: **0** — Евеліна (українська), **1** — англійська Canary, **2** — цифри й символи,
...
## 📜 Історія еволюції «Евеліни»

Розкладка не стала такою за один день:

- **Евеліна 3.0 — аналіз біграм.** Перша серйозна спроба розвести найчастіші біграми
  («сп», «тр», «нш») для комфортних перекатів.

  <img src="images/eva-3.0.png" alt="Розкладка Евеліна 3.0" width="600">
...
- **Евеліна 3.2 — пунктуація та периферія.** Початок експериментів з розділовими знаками
  та розміщенням рідкісних літер на краях; Є переїхала на лівий мізинець.

  <img src="images/eva-3.2.png" alt="Розкладка Евеліна 3.2" width="600">

- **Евеліна 3.6 — робота над шарами.** Основна матриця лишилася як у 3.2, змінилася
  логіка додаткових шарів і службових клавіш.

  <img src="images/eva-3.6.png" alt="Розкладка Евеліна 3.6" width="600">

- **Евеліна 3.7 — майже фінал.** І, Ю, Л знайшли свої місця (І в центрі верхнього ряду,
  Ю на мізинці), але кома та крапка ще потребували змін.

  <img src="images/eva-3.7.png" alt="Розкладка Евеліна 3.7" width="600">
...
- **Евеліна 3.8 — ідеальна пунктуація.** З основної зони прибрано Delete — кома та крапка
  стали на зручні позиції нижнього ряду. Довгий час була рекомендованою версією
  (файл: [Eva.vil](Eva.vil)).

  <img src="images/eva-3.8.png" alt="Розкладка Евеліна 3.8" width="600">
...
- **Евеліна 3.9 — кількісний аудит** (див. вище). Аналіз на корпусі 6.2 млн літер показав,
...
перемикання мови не ламає звичок. Чесна ціна: SFB 5.15 % — вищий, ніж у Евеліни
(фонетичні позиції І та С ділять один палець із В та И — біграми «ви», «ис», «си»).
Якщо українська для вас основна — беріть Евеліну; Canary Phonetic UA — для
...
[ПРОПОЗИЦІЇ.md](ПРОПОЗИЦІЇ.md): «Евеліна 3.9» (три обміни поза домашнім рядом:
−42 % SFB при незмінному домашньому ряді), «Евеліна 3.9+» (мінімальний SFB)
та «Ліна 2.0» (перегенерована чесною моделлю).

## 🤝 Внесок

Ергономіка — нескінченний процес. Тестуйте Евеліну 3.9, експериментуйте з Ліною,
