...
# Евеліна 3.8 (README, 6 колонок на половину)
LAYOUTS["Евеліна 3.8"] = grid(
    ["- я й п к д", "є и в т с р", "- ж ц з б м"],
    ["г л у і щ ї", "х н о а е ю", "ш ч - - ь ф"],
    [0, 0, 1, 2, 3, 3],
    [3, 3, 2, 1, 0, 0],
)
LAYOUTS["Евеліна 3.8"]["ґ"] = LAYOUTS["Евеліна 3.8"]["г"]  # tap-hold Г→Ґ

# Евеліна 3.9 (рекомендована: обміни М<->Ч, К<->Ц, Д<->З відносно 3.8)
LAYOUTS["Евеліна 3.9"] = grid(
    ["- я й п ц з", "є и в т с р", "- ж к д б ч"],
    ["г л у і щ ї", "х н о а е ю", "ш м - - ь ф"],
    [0, 0, 1, 2, 3, 3],
    [3, 3, 2, 1, 0, 0],
)
LAYOUTS["Евеліна 3.9"]["ґ"] = LAYOUTS["Евеліна 3.9"]["г"]  # tap-hold Г→Ґ
